  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to ABAR - Where User Interaction is Not Just a Feature, It's Our Core Principle. Engage, Connect, and Collaborate Like Never Before."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1642888621621-ff7d83f3fdcf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx1c2VyJTIwaW50ZXJhY3Rpb258ZW58MHx8fHwxNjkzOTkxMjEwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@m_stuckey?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Mark Stuckey`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to ABAR - Where User Interaction is Not Just a Feature, It's Our Core Principle. Engage, Connect, and Collaborate Like Never Before.`}
            </Text>
            <Box
